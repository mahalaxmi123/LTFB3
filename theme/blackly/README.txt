...
Blacklytheme - Installation steps
================================

1) On your download pacakge, you will find theme_blackly.zip

2) Unzip - theme_blackly.zip, you will get folder 'blackly'

3) Copy folder 'blackly' and put into theme folder of your moodle system
...
8) By clicking "Continue" button on success page , you will get options to change the blacklytheme settings.
   You can modify the settings later too :-)


Steps to set blacklytheme as default theme for your moodle system
==================================================================
...
5) Then click "Use theme" button on "Blacklytheme"
