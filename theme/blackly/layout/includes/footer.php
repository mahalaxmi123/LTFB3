<?php
$footnote = theme_blackly_get_setting('footnote', 'format_html');

$fburl = theme_blackly_get_setting('fburl');
$pinurl = theme_blackly_get_setting('pinurl');
$twurl = theme_blackly_get_setting('twurl');
$gpurl = theme_blackly_get_setting('gpurl');

$address = theme_blackly_get_setting('address');
$emailid = theme_blackly_get_setting('emailid');
$phoneno = theme_blackly_get_setting('phoneno');
$copyright_footer = theme_blackly_get_setting('copyright_footer');
$infolink = theme_blackly_get_setting('infolink');
	...
	<div class="footer-main">
  	<div class="container">
    	<div class="row-fluid">
      	<div class="span5">
        	<div class="infoarea">
          	<div class="footer-logo"><a href="#"><img src="<?php echo get_logo_url(); ?>" width="243" height="77" alt="Blackly"></a></div>
             <?php echo $footnote; ?>
          </div>
        </div>
      	<div class="span3">
