...
/**
 * Strings for component 'theme_medilearn', language 'en'
 *
...
<div class="well">
<h2>Medilearn</h2>
<p><img class=img-polaroid src="medilearn/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About</h3>
<p>Medilearn is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
...
<p><a href="medilearn/README.txt">How to copy and customise this theme.</a></p>
</div></div>';
...
$string['bannersettingssub'] = 'These settings control the slideshow that appears on the Medilearn Dashboard.';
